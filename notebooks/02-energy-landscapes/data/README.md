...
|---|---|---|---|---|
| `geo-opt.inp` | Geometry-optimisation input deck for the LJ38 cluster | CP2K | FS 2023 ETHZ MMM course | CC-BY-4.0 |
| `lj38-energy.dat` | Cluster energy against optimisation step | CP2K | FS 2023 ETHZ MMM course | CC-BY-4.0 |
| `lj38-optimization.xyz` | Optimisation trajectory of the 38-atom cluster | CP2K | FS 2023 ETHZ MMM course | CC-BY-4.0 |
