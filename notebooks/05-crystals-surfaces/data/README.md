...
|---|---|---|---|---|
| `Ag-eos.traj` | Equation-of-state scan for silver | ASE, EMT potential | FS 2023 ETHZ MMM course | CC-BY-4.0 |
| `Ni-ac-scan.traj` | Lattice-parameter (a, c) scan for nickel | ASE, EMT potential | FS 2023 ETHZ MMM course | CC-BY-4.0 |
| `pt-slab.xyz` | Clean platinum slab structure | CP2K | FS 2023 ETHZ MMM course | CC-BY-4.0 |
| `benzene-mol.xyz` | Isolated benzene molecule | CP2K | FS 2023 ETHZ MMM course | CC-BY-4.0 |
| `benzene-on-pt.xyz` | Benzene adsorbed on the platinum slab | CP2K | FS 2023 ETHZ MMM course | CC-BY-4.0 |
