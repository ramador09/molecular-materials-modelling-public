...
slab fixes its **adsorption energy**, the central quantity of heterogeneous catalysis.
These notebooks work from the course's own calculations, run with the Atomic
